...
| R-P0-06 | Brief 点击确认即锁定；失败以同一快照重试；继续补问与重新准备按不同规则回退，LIVE 后均不可用 | 产品 7.5；领域 3 | P0-14、P0-15 | AT-023、AT-036～038 | 待实现 |
...
| R-P0-13 | 可标记决策、候选创意、洞察、行动项；行动项元数据可选，同一节点最多一个有效产出 | 产品 6、7.9；ADR 0003 | P0-22 | AT-080～081、AT-085 | 待实现 |
| R-P0-14 | LIVE 累计人时、结束后总人时和产出形成成本由确定性代码计算 | 产品 7.9；领域 6 | P0-04、P0-22 | AT-073、AT-077、AT-082、AT-084 | 待实现 |
