...
| R-P0-06 | Brief 可编辑确认；初始图成功后锁定，重新准备会清图且 LIVE 后不可用 | 产品 7.5；领域 3 | P0-14、P0-15 | AT-036、AT-023 | 待实现 |
| R-P0-07 | 初始图为一个根、3–5 个一级议题、最多 12 节点和两层，失败不写半成品 | 产品 7.5；ADR 0001 | P0-15 | AT-040～043 | 待实现 |
...
| R-P0-10 | 随手记 Enter 即写当前议题，不依赖 AI；手工编辑始终可用 | 产品 7.8；UI 10.4 | P0-20 | AT-063、AT-065 | 待实现 |
| R-P0-11 | 会中提供开场、议题、转场和散会的轻量主持人小抄 | 产品 7.7；UI 10 | P0-19 | AT-066 | 待实现 |
| R-P0-12 | 同一浏览器只允许一场 LIVE，开始时确认人数，时间经过不自动改生命周期 | 产品 7.6、7.7；领域 3、4 | P0-21 | AT-070～072、AT-076 | 待实现 |
| R-P0-13 | 可标记决策、候选创意、洞察、行动项；行动项元数据可选 | 产品 6、7.9；ADR 0003 | P0-22 | AT-080～081 | 待实现 |
| R-P0-14 | 总人时和两个产出标记之间的形成成本由确定性代码计算 | 产品 7.9；领域 6 | P0-04、P0-22 | AT-073、AT-082、AT-084 | 待实现 |
| R-P0-15 | 散会前软检查和二次确认；零产出也允许结束；ENDED 不回 LIVE | 产品 7.10；领域 3 | P0-23 | AT-076、AT-090～091 | 待实现 |
| R-P0-16 | 结束后生成模式化 Markdown；最多 3 个确定性 Mermaid，失败有文本降级 | 产品 7.11；AI 9；UI 12 | P0-24～026 | AT-092～096 | 待实现 |
| R-P0-17 | 会议业务数据仅存 IndexedDB；完整 JSON 导出不含 Key | 产品 7.13；ADR 0002 | P0-05、P0-06 | AT-100～102 | 待实现 |
...
| R-ST-02 | 随手记 AI 建议当前子树中的父节点，用户确认后移动 | ST-02 | AT-064 | 候选 |
| R-ST-03 | 会后补记，且不计形成成本 | ST-03 | AT-083 | 候选 |
| R-ST-04 | 超时 LIVE 会议恢复向导 | ST-04 | AT-074 | 候选 |
| R-ST-05 | 手机端树状会议操作 | ST-05 | AT-114 | 候选 |
