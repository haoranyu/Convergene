...
| R-P0-02 | 用户以匿名设备会话保存自己的 StepFun/硅基流动配置，Key 不回显 | 产品 7.2；ADR 0002 | P0-07、P0-08 | AT-010～015 | 待实现 |
...
| R-P0-08 | 工作台呈现 LR 单向树，当前议题与选中节点分离，只在显式操作时聚焦 | 产品 7.7；UI 10；ADR 0001 | P0-16、P0-17 | AT-050～053 | 待实现 |
...
| R-P0-16 | 结束后生成模式化 Markdown；最多 3 个确定性 Mermaid，失败有文本降级 | 产品 7.11；AI 9；UI 12 | P0-24～026 | AT-092～096 | 待实现 |
